...
class CentrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post centros_url, params: { centro: { descripcion: @centro.descripcion, latitud: @centro.latitud, longitud: @centro.longitud, nombre: @centro.nombre, url: @centro.url } }
    end
  ...
  test "should update centro" do
    patch centro_url(@centro), params: { centro: { descripcion: @centro.descripcion, latitud: @centro.latitud, longitud: @centro.longitud, nombre: @centro.nombre, url: @centro.url } }
